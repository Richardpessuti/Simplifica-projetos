...
- **Hospedagem**: **GitHub Pages**, publicado direto do repositório `Richardpessuti/Simplifica-projetos`, branch `claude/leitura-perguntas-917odr`, pasta `/ (root)`. Domínio próprio via arquivo `CNAME` na raiz do repo. Link ao vivo: **https://simplificaseuprojeto.com.br/**. Deploy automático a cada push — sem passo manual.
